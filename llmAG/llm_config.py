...
ANSWER_SYSTEM_PROMPT = (
    ...
    "If only part of the question is supported, answer only that part and state that the "
    "remaining parts are not in the provided context; do not ask to search online.\n"
